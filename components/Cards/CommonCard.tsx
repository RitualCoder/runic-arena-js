...
const BasicCard: React.FC<BasicCardProps> = ({ card, display = true }) => {
  const [expanded, setExpanded] = useState(false);
  const cardRef = useRef<HTMLDivElement | null>(null);

  // Utilisation du hook factorisé pour les interactions
  ...
  return (
    ...
    >
      <div className="card-content overflow-hidden">
        {/* Fond de la carte selon le type */}
        <img
        ...
        {/* Image de la carte */}
        <div className="absolute top-[43px] left-[25px] border-black h-[183px] w-[290px] bg-transparent user-drag-none">
          <img
            draggable="false"
            src={
        ...
        <div className="flex absolute z-20 bottom-[12px] right-[18px] w-[160px] h-[32px] text-right items-center overflow-hidden">
          <p className="card-description w-full font-Mitra font-medium text-[11px] leading-[11px] text-right">
            {card.description}
          </p>
        </div>

        {/* Faiblesse */}
        <div className="absolute font-GillSans font-bold z-20 bottom-[53.5px] left-[20px] w-[160px] text-[7px] items-center">
          <p>Faiblesse</p>
        </div>

        {/* Résistance */}
        <div className="absolute font-GillSans font-sem z-20 bottom-[53.5px] left-[107px] text-[7px] items-center overflow-hidden">
          <p>Résistance</p>
        </div>
        ...
        {/* Illustration */}
        <div className="absolute flex flex-col z-20 bottom-[15px] left-[20px] gap-[1px]">
          <p className="w-full font-GillSans font-sem text-[6px] leading-[6px]">
            Illus. Runic Arena
          </p>
          <p className="text-[7px] flex items-center font-GillSans">
            001/151 <span className="text-[8px] ml-[2px]">●</span>
          </p>
        </div>

        {/* Credits */}
        <div className="absolute z-10 bottom-[4px] left-0 w-full text-black">
          <p className="w-full font-GillSans font-sem text-[6px] leading-[6px] text-center">
        ...
        <div className="effects absolute top-0 left-0 w-full h-full">
          <div className="shine z-20 absolute h-full w-full top-0 bg-transparent"></div>
